...
const cards = [
    ...
    {
        title: 'AD Remove Plan',
        price: 'Months 1.5 USD',
        features: [
            'All Basic Plan Features (excluding App AD)',
            'App AD Remove(Include website)',
        ]
    },
    {
        title: 
        ...
        '제작중',
        price: 
        // 'Months 3.5 USD, Years 37 USD',
        '제작중',
        features: [
            // 'All AD Remove Plan Features',
            // 'CPU/RAM Usage Monitoring and Notifications',
            // 'Auto update',
            // 'config',
            // 'Basic system Optimization',
            // 'Executive Program List and Usage Time',
